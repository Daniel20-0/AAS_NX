...
# 
#        Filename:  C:\Users\chris\Documents\EntwicklungsPorjekt_AAS_Master\Entwicklungsprojekt_AAS\AAS_NX\Quellcode\NXAddAttributesTool.py
# 
#         This file was generated by the NX Block UI Styler
#         Created by: chris
#               Version: NX 1996
#               Date: 03-31-2026  (Format: mm-dd-yyyy)
#               Time: 13:22 (Format: hh-mm)
# 
#==============================================================================
...
class NXAddAttributesTool:
    ...
    def __init__(self):
        try:
            ...
            self.theDlxFileName = "NX Add Attributes Tool.dlx"
...
def main():
    theNXAddAttributesTool = None
    try:
        theNXAddAttributesTool =  NXAddAttributesTool()
        #  The following method shows the dialog immediately
        theNXAddAttributesTool.Show()
    except Exception as ex:
        # ---- Enter your exception handling code here -----
        NXOpen.UI.GetUI().NXMessageBox.Show("Block Styler", NXOpen.NXMessageBox.DialogType.Error, str(ex))
    finally:
        if theNXAddAttributesTool != None:
            theNXAddAttributesTool.Dispose()
            theNXAddAttributesTool = None
