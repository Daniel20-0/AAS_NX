...
### 8.1 Automated import of CAD data from the AAS
...
### 8.2 Assignment of a unique Asset ID (Digital Thread)
...
### 8.3 Data export for Bills of Materials (BOM) and AAS synchronization
...
### 8.4 UI customization and user interaction
